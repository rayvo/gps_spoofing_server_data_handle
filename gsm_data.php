...
<body>
	...
	<?php
        $all_data = $conn->query("SELECT * FROM gsm_data");
		...
		$page_data = $conn->query("SELECT * FROM gsm_data LIMIT ".$per_page. " OFFSET ".$offset);
	 ?>
	...
	<section>
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<h2 class="text-center">Table GSM_DATA</h2>
            ...
            <div class="col-sm-12" >
                <button class="btn btn-primary" onclick="location.href='main.php'">GPS_DATA</button>                
            </div>
		</div>
	</section>
